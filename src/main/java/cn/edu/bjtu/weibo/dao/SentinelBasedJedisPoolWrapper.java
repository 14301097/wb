...
public class SentinelBasedJedisPoolWrapper extends Pool<Jedis> {
  ...
  public SentinelBasedJedisPoolWrapper(final GenericObjectPoolConfig poolConfig, int timeout, final String password, int database, String masterName, Set<String> sentinels) {
